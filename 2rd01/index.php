    ...
    <div id="main">
        ...
        <div id="ms">
            ...
            <div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
                ...
                <div style="width:89%; height:480px;" class="dbor">
                    ...
                    <div class="cent">
                        <img src="./icon/up.jpg" onclick="pp(1)" alt="" srcset="">
                    </div>
                    <?php
                    $imgs = $Image->all(['sh' => 1]);
                    // dd($imgs);
                    ...
                    ?>
                        <div class="im cent">
                            <img id="ssaa<?= $idx ?>" src="./image/<?= $img['img'] ?>" alt="" srcset="">
                        </div>
                    <?php } ?>
                    <div class="cent">
                        <img src="./icon/dn.jpg" onclick="pp(2)" alt="" srcset="">
                    </div>
                    <script>
                        var nowpage = 0,
                            num = 0;
        ...
        <div
            ...
            <span class="t" style="line-height:123px;">
                <?php
                echo $bottom = $Bottom->find(1)['text'];
                ?>
            </span>
        </div>
    </div>
