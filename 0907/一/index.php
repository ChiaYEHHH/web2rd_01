...
<body>
	...
	<div id="main">
		...
		<a title="<?= $title['text'] ?>" href="index.php">
			<div class="ti" style="background:url('./image/<?= $title['img'] ?>'); background-size:cover;">
				...
				<div id="menuput" class="dbor">
					...
					?>
						...
						<div class="mainmu">
							...
							?>
								<div class="mainmu2">
									<a style="color:#000; font-size:13px; text-decoration:none;" href="<?= $s['href'] ?>"><?= $s['text'] ?></a>
								</div>
							<?php endforeach; ?>
						</div>
		...
		<div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
			...
			<div style="width:89%; height:480px;" class="dbor">
				...
				?>
				<div class="im cent" id="ssaa<?= $idx; ?>" style="margin:15px">
						<img src="./image/<?= $img['img']; ?>" style=" width: 150px;height: 103px; border:3px solid orange">
				</div>
				<?php endforeach; ?>
