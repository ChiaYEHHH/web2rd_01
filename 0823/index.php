    ...
    <div id="main">
        ...
        <div id="ms">
            ...
            <div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
                <!--右邊-->
                <a href="?do=login"><button
                        style="width:100%; margin-left:auto; margin-right:auto; margin-top:2px; height:50px;">管理登入</button></a>
...
<?php
					...
					foreach($image as $imgs => $img):
?>
<div class="im cent" id="ssaa<?=$imgs?>" style="margin:15px 0">
	<img src="./image/<?=$img['img']?>" style="width:150px;height:103px;border:2px solid orange">
</div>
<?php endforeach;?>
